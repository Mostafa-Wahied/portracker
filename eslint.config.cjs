...
module.exports = [
  ...
  'no-console': 'error',
  // Soften a few base rules to warnings for now
  'no-unused-vars': 'warn',
  'no-useless-escape': 'warn',
  'no-empty': 'warn',
      'logs/no-emoji-in-logs': 'error',
      'logs/no-debug-gated-info-warn': 'error',
      'logs/logger-requires-metadata': 'warn',
      'logs/error-object-in-logger-error': 'warn',
      'logs/no-raw-req-res-body-logging': 'warn',
    },
  },
